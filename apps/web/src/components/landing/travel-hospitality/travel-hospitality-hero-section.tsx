...
import { Globe, Headphones, MessageSquare, Shield } from "lucide-react";
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="text-left relative">
            ...
            >
              Support guests 24/7 in multiple languages with AI chatbots and voice
              bots handling common queries. Our unified inbox and Generative AI
              tools empower agents across channels to resolve issues efficiently.
              Perfect for hotels, airlines, travel agencies, and hospitality
